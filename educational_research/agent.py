...
"""educational-research: Research advice, related literature finding, research area proposals, web knowledge access."""

from google.adk.agents import LlmAgent
from google.adk.tools.agent_tool import AgentTool

from . import prompt
from .sub_agents.insights_research import insights_agent
from .sub_agents.data_research import data_agent
